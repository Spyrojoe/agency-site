<div class="main-navigation">
	...
	<nav id="side_nav">
		<ul id="main_nav">
			...
			<li class="nav_about <?= inPage('/digital/aboutus.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/digital/aboutus.php">About Us</a>
			</li>

			<li class="nav_capabilities <?= inPage('/digital/capabilities.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/digital/capabilities.php">Capabilities</a>
			</li>
			
			<li class="nav_work <?= inPage('/digital/work.php') ? ' nav_selected' : '' ?>">
			...
			<li class="nav_team <?= inPage('/digital/team.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/digital/team.php">Team</a>
			</li>

			<li class="nav_clients <?= inPage('/digital/experience.php') ? ' nav_selected' : '' ?>">
			...
			*/?>
			...
			<li class="nav_insurance <?= inSection('insurance') ? ' nav_selected' : '' ?>">
			...
			<li class="nav_careers <?= inPage('/careers/index.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/careers/">Careers</a>
			</li>

			<li class="nav_news <?= inPage('/news/index.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/news/">News</a>
			</li>

			<li class="nav_contact <?= inPage('/contact.php') ? ' nav_selected' : '' ?>">
				<a class="nav_btn" href="/contact.php">Contact</a>
			</li>
			<li class="nav_clientlounge">
				<a class="nav_btn" href="http://www.clientlounge.com" target="_blank">Clientlounge</a>
			</li>
			<!--
			<li class="nav_clientlounge <?= inPage('/clientlounge.php') ? ' nav_selected' : '' ?>">
